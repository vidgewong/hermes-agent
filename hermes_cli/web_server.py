...
_BUILTIN_DASHBOARD_THEMES = [
    ...
    {"name": "mercedes-benz", "label": "Mercedes-Benz", "description": "Three-pointed stars scattered like a cosmos — premium dark silver"},
    {"name": "mercedes-benz-light", "label": "Mercedes-Benz Light", "description": "Warm parchment canvas — premium light mode with Mercedes precision"},
]
...
async def get_dashboard_themes():
    ...
    """
    config = load_config()
    active = cfg_get(config, "dashboard", "theme", default="mercedes-benz-light")
