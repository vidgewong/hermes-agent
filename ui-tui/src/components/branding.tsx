...
const TAG_FULL = 'Mercedes-Benz · Digital Worker Platform'
const TAG_MID = 'Digital Worker Platform'
const TAG_TINY = 'Mercedes-Benz'
const HIDE_BELOW = 34
...
export function SessionPanel({ info, maxWidth, sid, t }: SessionPanelProps) {
  ...
  const leftW = Math.min((artWidth(heroLines) || CADUCEUS_WIDTH) + 4, Math.floor(cols * 0.35))
  const wide = cols >= 70 && leftW + 30 < cols
      ...
      {wide && (
        <Box flexDirection="column" marginRight={2} width={leftW}>
          ...
          <Text color={t.color.accent}>
            ...
            <Text color={t.color.muted}> · Mercedes-Benz</Text>
          </Text>
